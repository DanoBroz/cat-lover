...
export const Navbar = () => {
  const linkClass = 'rounded-lg py-[10px] px-6 text-xl transition-colors'
  const activeClass = `${linkClass} bg-Blue-400 text-Blue-50 hover:bg-Blue-400/80`
  const inactiveClass = `${linkClass} bg-Blue-100 text-Blue-400 hover:bg-Blue-400/80 hover:text-Blue-50 text-center`
